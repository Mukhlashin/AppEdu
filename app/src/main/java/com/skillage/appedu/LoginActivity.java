...
public class LoginActivity extends AppCompatActivity {
    ...
    private class LoadingSiswa extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            db.getRecords("Select * from t_siswa where userid='"+userid+"'");
            return null;
        }
        ...
        protected void onPostExecute(String rs) {
            if (!db.isEmpty()) {
                ...
                GlobalVar.Saldo=  Integer.parseInt( db.Records.get(0).get("saldo"));
    ...
    private class LoadingGuru extends AsyncTask<String, String, String> {
        ...
        @Override
        protected String doInBackground(String... params) {
            db.getRecords("Select * from t_guru where userid='"+userid+"'");
            return null;
        }
